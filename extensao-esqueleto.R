...
dados_sim<-read.csv("Mortalidade_Geral_2015.csv", head = T, sep =';')
...
sidra_2015<-read.csv2('tabela6579.csv', head = T, sep = ';') 

sidra_2010SEX<-read.csv2('população residente censo 2010 - UF e municípios - total e por sexo - SIDRA - tabela_1552.xlsx', head = T, sep = ';')
